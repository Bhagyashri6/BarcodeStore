 ...
 *
 */
public class SliderLayoutNew extends RelativeLayout {
    ...
    public SliderLayoutNew(Context context) {
        this(context,null);
    }

    public SliderLayoutNew(Context context, AttributeSet attrs) {
        this(context,attrs, com.daimajia.slider.library.R.attr.SliderStyle);
    }

    public SliderLayoutNew(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void addOnPageChangeListener(ProductDetails mainActivity) {
