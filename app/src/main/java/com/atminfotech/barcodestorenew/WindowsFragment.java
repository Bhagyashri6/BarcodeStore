 ...
 */
public class WindowsFragment extends ListFragment implements AdapterView.OnItemClickListener{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            if (response != null && response.getPropertyCount() > 0) {
                ...
                for (int i = 0; i < response.getPropertyCount(); i++) {
                    ...
                    if(obj.getProperty("TransportName").toString().equals("Windows")) {
